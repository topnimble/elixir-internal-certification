defmodule ElixirInternalCertificationWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_elixir_internal_certification_key",
    signing_salt: "TaSlUqrE"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :elixir_internal_certification,
    gzip: true,
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :elixir_internal_certification
  end
  ...
  plug ElixirInternalCertificationWeb.Router
end
