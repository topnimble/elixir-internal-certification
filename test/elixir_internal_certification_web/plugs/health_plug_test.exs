defmodule ElixirInternalCertificationWeb.HealthPlugTest do
  use ElixirInternalCertificationWeb.ConnCase, async: true

  import ExUnit.CaptureLog

  alias ElixirInternalCertificationWeb.HealthPlug
  ...
  describe "call/2" do
    ...
    test "given the database is not ready, returns 500 internal server error " do
      expect(Ecto.Adapters.SQL, :query, fn ElixirInternalCertification.Repo, "SELECT 1" ->
